...
<html lang="{{ app()->getLocale() }}">
   ...
   <!--<img src="../../public/ruet.PNG" alt="RUET" style="width:128px;height:128px;">
     <div class="flex-center position-ref full-height"> </div><img src="{{ URL::to('http://localhost/admission/public/img/ruet.PNG') }}"><img src="ruet.PNG" alt="RUET" width="1350" height="150"><br>-->
            ...
            <div class="content">
                <img src="ruet.PNG" alt="RUET" width="1350" height="150">
                    ...
                    <div class="col-md-6 offset-md-4">
                        <a href="{{url('/login')}}">
                            <button type="button" class="btn btn-primary">
                                <b><font size="3" color="blue">  ADMIN</font></b>
                            </button>
                        <a href="{{url('/result')}}">
                            <button type="button" class="btn btn-primary">
                                <b><font size="3" color="blue">  All Student Result</font></b>
                            </button>
                        <a href="{{url('/individual')}}">
                            <button type="button" class="btn btn-primary">
                                <b><font size="3" color="blue">  Individual Result</font></b>
                            </button>
                    </div>
                </div>
            </div>
